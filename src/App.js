                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  <div className="form-row2">
                    <div className="fld">
                      ...
                      <input className="fld-input" name="name" value={form.name} onChange={onChange} placeholder="Your name" required />
                    </div>
                    <div className="fld">
                      <label className="fld-label">Email</label>
                      <input className="fld-input" type="email" name="email" value={form.email} onChange={onChange} placeholder="your@email.com" required />
                    </div>
                  </div>
                  <div className="form-row2">
                    <div className="fld">
                  ...
                  <button type="submit" className="btn btn-gold" style={{ width: "100%", justifyContent: "center", padding: "15px" }}>
                    ✦ Send Message
                  </button>
                </div>
              </form>
